...
from core.utils import get_all_entries, process_bib_entries, write_bib_file
...
def process_bib_file(input_file, output_file=None):
    ...
    Args:
        ...
        output_file (str, optional): Path to output .bib file. If None, only statistics will be shown.
    """
    try:
